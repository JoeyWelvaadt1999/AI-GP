...
class HUWebshop(object):
    ...
    dbstring = 'mongodb+srv://daniloDbUser:Joeydanilo1%21@danilo.sxj7r.gcp.mongodb.net/danilo?retryWrites=true&w=majority'
    recseraddress = "http://localhost:5001"
    ...
    def recommendations(self, count, productid):
    ...
    #  command: 'c:\users\joeyw\appdata\local\programs\python\python38-32\python.exe' 'c:\users\joeyw\appdata\local\programs\python\python38-32\lib\site-packages\pip\_vendor\pep517\in_process\_in_process.py' prepare_metadata_for_build_wheel 'C:\Users\joeyw\AppData\Local\Temp\tmpugi782xa'
    #      cwd: C:\Users\joeyw\AppData\Local\Temp\pip-install-qcm9a0qb\pywinpty_d877f3b771f947a0aa8df63f935faf2f
    ...
    # Checking for Rust toolchain....'''
        ...
        resp = requests.get(self.recseraddress+"/"+productid)
        print(self.recseraddress+"/"+productid, file=sys.stderr)
        
        if resp.status_code == 200:
            # recs = eval(resp.content.decode())
            recs = json.loads(resp.text)
            tmp = []
            for  rec in recs:
                tmp.append(rec["id"])
   
            queryfilter = {"_id": {"$in": tmp}}
    ...
    def productpage(self, cat1=None, cat2=None, cat3=None, cat4=None, page=1):
        ...
        print( prodlist[0]['id'], file=sys.stderr)
        ...
        return self.renderpackettemplate('products.html', {'products': prodlist, \
            ...
            'r_products':self.recommendations(4, prodlist[0]['id']), \
    ...
    def productdetail(self, productid):
        ...
        return self.renderpackettemplate('productdetail.html', {'product':product,\
            ...
            'r_products':self.recommendations(4, productid), \
    ...
    def shoppingcart(self):
        ...
        return self.renderpackettemplate('shoppingcart.html',{'itemsincart':i,\
            'r_products':self.recommendations(4, prodid), \
